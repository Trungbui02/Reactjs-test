  ...
  return (
    <div className="container">
      <div className="area-contents">
        ...
        <button onClick={handleClickProfile} className="btn-profile">
          Profile
        </button>
        {isLoggedin && (
          <button onClick={handleClickLogOut} className="btn-logout">
            Log Out
          </button>
        )}
      ...
      <div className="testimonials">
        ...
        <div className="slide">
          ...
          <div className="portfo">
            <div className="lio">
              <p className="name">John Fang</p>
              <p className="web">wordfaang.com</p>
            </div>
